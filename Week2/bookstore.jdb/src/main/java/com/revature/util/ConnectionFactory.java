...
public class ConnectionFactory {
	 ...
	 * instance each time one is requested so that we can monitor the amount of connections that our 
	 ...
	 * 
	 * put everything in a db properties file. Then access that file with this class
	 */
	public Connection getConnection() {
		Connection conn = null;
		Properties prop = new Properties();
		String path = "C:/Users/Margy/git_repos/RevWork/Week2/bookstore.jdb/src/main/java/com/revature/util/database.properties";
		try {
