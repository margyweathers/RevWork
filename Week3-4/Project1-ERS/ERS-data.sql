...
INSERT INTO USR(EMAIL, PWD, FIRSTNAME, LASTNAME, ROLL, APPROVED)
  VALUES('fred@gmail.com', 'pass', 'Fred', 'Airley', 1, 1);
INSERT INTO USR(EMAIL, PWD, FIRSTNAME, LASTNAME, ROLL, APPROVED)
  VALUES('sean@gmail.com', 'pass', 'Sean', 'Young', 1, 0);
INSERT INTO USR(EMAIL, PWD, FIRSTNAME, LASTNAME, ROLL, APPROVED)
  VALUES('manager@gmail.com', '123', 'Financial', 'Manager', 2, 1);
INSERT INTO USR(EMAIL, PWD, FIRSTNAME, LASTNAME, ROLL, APPROVED)
  VALUES('craigerator@gmail.com', '123', 'Michael', 'Craig', 2, 1);
...
SELECT * FROM USR ORDER BY LASTNAME;
SELECT * FROM USR WHERE EMAIL = 'mweathers@gmail.com';
SELECT EMAIL FROM USR;
delete from reimbursements where r_id = 51;
